...
function App() {
    ...
    return (
      <div className="fixed inset-0 bg-[#050A30] z-[100] flex flex-col items-center justify-center transition-opacity duration-500">
        <div className="relative animate-logo-intro">
           <div className="w-24 h-24 rounded-3xl border-2 border-[#4FFFB0] flex items-center justify-center shadow-[0_0_30px_rgba(79,255,176,0.3)]">
              <span className="text-[#4FFFB0] text-5xl font-bold font-heading">SP</span>
           </div>
        </div>
  ...
  return (
    <div className="min-h-screen text-[#050A30] font-body selection:bg-[#4FFFB0] selection:text-[#050A30] relative overflow-hidden">
      ...
      {/* BACKGROUND BUBBLES / INDIRECT LIGHTS */}
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        {/* Top Right - Green/Cyan Glow */}
        <div className="blob blob-neon w-[500px] h-[500px] top-[-10%] right-[-10%] opacity-40 blur-[100px]"></div>
        
        {/* Bottom Left - Purple Glow */}
        <div className="blob blob-purple w-[600px] h-[600px] bottom-[-10%] left-[-10%] opacity-30 blur-[120px]" style={{ animationName: 'float-delayed' }}></div>
        
        {/* Center Right - Blue Glow */}
        <div className="blob blob-blue w-[400px] h-[400px] top-[40%] right-[10%] opacity-20 blur-[80px]"></div>
      </div>

      {/* Navbar */}
      <nav className="fixed w-full z-50 transition-all duration-300 bg-white/10 backdrop-blur-lg border-b border-white/20 shadow-sm">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center shadow-inner border border-white/50 backdrop-blur-md">
              <span className="font-bold text-xl text-[#050A30]">SP</span>
            </div>
            <span className="font-bold text-xl tracking-tight text-[#050A30]">DIGITAL</span>
          </div>
          
          <div className="hidden md:flex items-center gap-8 text-sm font-bold tracking-wide text-[#050A30]/80">
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 w-full bg-white/90 backdrop-blur-xl border-b border-gray-100 p-6 flex flex-col gap-4 shadow-xl animate-enter">
        ...
        <div className="container mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8 animate-enter relative z-10">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/40 bg-white/30 backdrop-blur-md shadow-sm">
              <span className="w-2 h-2 rounded-full bg-[#4FFFB0] shadow-[0_0_10px_#4FFFB0]"></span>
          ...
          <div className="relative perspective-1000 animate-enter" style={{animationDelay: '0.2s'}}>
             ...
             <div className="relative w-full max-w-md mx-auto aspect-square">
                {/* Floating Elements */}
                <div className="absolute top-[-20px] right-[-20px] w-20 h-20 bg-gradient-to-br from-[#4FFFB0] to-transparent rounded-full opacity-60 blur-xl animate-pulse"></div>
                <div className="absolute bottom-[-10px] left-[-10px] w-32 h-32 bg-gradient-to-tr from-[#3b82f6] to-transparent rounded-full opacity-40 blur-xl"></div>
                
                {/* Main Card */}
                <GlassCard className="w-full h-full p-2 bg-gradient-to-br from-white/90 to-white/40 border border-white/80 shadow-2xl">
                    ...
                    <div className="absolute bottom-6 left-6 right-6">
                      <div className="bg-white/80 backdrop-blur-xl p-4 rounded-2xl shadow-lg border border-white/60">
                        <div className="flex justify-between items-center mb-2">
                          ...
                          <span className="text-xs font-bold px-2 py-1 bg-[#4FFFB0] text-[#050A30] rounded-full shadow-[0_0_10px_rgba(79,255,176,0.5)]">Ativo</span>
                        </div>
            ...
            <div className="min-w-[70vw] md:min-w-0 md:col-span-1 md:row-span-1 snap-center">
               <GlassCard className="h-full bg-[#050A30] group overflow-hidden !p-0 flex items-center justify-center relative !rounded-[2rem]">
                   ...
                   <div className="text-center z-10">
                      <div className="w-16 h-16 mx-auto bg-white/10 rounded-full flex items-center justify-center border border-white/20 backdrop-blur-sm mb-4 group-hover:scale-110 transition-transform">
                        <span className="font-heading text-2xl font-bold text-white group-hover:text-[#4FFFB0] transition-colors">L</span>
                      </div>
                      <div className="text-white/50 text-xs uppercase tracking-widest">Identidade</div>
                   </div>
               </GlassCard>
            </div>
        ...
        <div className="container mx-auto px-6">
          <RevealOnScroll>
            <div className="flex flex-col items-center text-center mb-16">
               <div className="w-20 h-20 bg-gradient-to-br from-white/10 to-transparent rounded-full flex items-center justify-center border border-white/10 mb-6 text-[#4FFFB0] shadow-[0_0_30px_rgba(79,255,176,0.1)]">
